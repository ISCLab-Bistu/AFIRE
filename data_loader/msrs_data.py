...
from models.common import RGB2YCrCb, ENW, MEW
...
class MSRS_data(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        enw = ENW(vis_image, inf_image)
        mew = MEW(vis_image, inf_image)
        ...
        return vis_image, vis_y_image, vis_cb_image, vis_cr_image, inf_image, name, enw, agw
