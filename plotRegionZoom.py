...
if __name__ == '__main__':
    ...
    line_list = [1]
    scale_list = [5]
    place_list = ['top right']
    img_path = r'E:\dataset\fusion\rgb\LLVIP\Inf/IR17.png'
    img_name = 'Inf_LLVIP.png'


    save_path = r'E:\task\fusion\PIAFusion\metric_image\plot_LLVIP/'
